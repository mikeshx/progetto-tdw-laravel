                    ...
                    <div class="row">
                        <div class="col-sm-3 col-md-3 col-lg-2 left-side">
                            ...
                            <ul class="nav">
                                ...
                                <li>
                                    <a href="{{ lang_url('admin/carousel_info') }}" class="btn waves-effect waves-light">
                                        <i class="material-icons">view_carousel</i>
                                        <p>{{__('admin_pages.carousel_info')}}</p>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="{{ lang_url('admin/coupons') }}" class="btn waves-effect waves-light">
                                        <i class="material-icons">C</i>
                                        <p>Coupons</p>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ lang_url('admin/support') }}" class="btn waves-effect waves-light">
